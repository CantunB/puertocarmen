...
@section('content')
    ...
    @component('components.breadcrumb')
        @slot('li_1') Softrestaurant @endslot
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="product-img position-relative">
                                ...
                                <img src="{{ URL::asset('/assets/images/product/img1.jpeg') }}" alt="" class="img-fluid mx-auto d-block">
                            </div>
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="product-img position-relative">
                                <img src="{{ URL::asset('/assets/images/product/img2.jpeg') }}" alt="" class="img-fluid mx-auto d-block">
                            </div>
                            <div class="mt-4 text-center">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="product-img position-relative">
                                ...
                                <img src="{{ URL::asset('/assets/images/product/img3.jpeg') }}" alt="" class="img-fluid mx-auto d-block">
                            </div>
                            <div class="mt-4 text-center">
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="product-img position-relative">
                                <img src="{{ URL::asset('/assets/images/product/img4.jpeg') }}" alt="" class="img-fluid mx-auto d-block">
                            </div>
                            <div class="mt-4 text-center">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="product-img position-relative">
                                ...
                                <img src="{{ URL::asset('/assets/images/product/img5.jpeg') }}" alt="" class="img-fluid mx-auto d-block">
                            </div>
                            <div class="mt-4 text-center">
                                <h5 class="mb-3 text-truncate"><a href="#" class="text-dark">Half sleeve T-Shirt</a></h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="product-img position-relative">
                                ...
                                <img src="{{ URL::asset('/assets/images/product/img6.jpeg') }}" alt="" class="img-fluid mx-auto d-block">
                            </div>
                            <div class="mt-4 text-center">
